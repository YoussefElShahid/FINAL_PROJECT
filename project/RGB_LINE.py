...
mGRE=[0.29709946,0.931483596,0.209086685]
sGRE=[0.012740885,0.005853078,0.012759629]
...
def color_choosing_LINE(color_list):
    '''if color_mapping(color_list,mRED,sRED):
        ...
        color=3'''
    if color_mapping (color_list,mGRE,sGRE):
        color=4
    else:
        color=7
